...
![Logo](./docs/assets/Logo_25.png) **欢迎来到 Operating-document 文档站！**
...
> [!NOTE]
>
> 注：此文本并未为协议的法律文本，详见：[https://creativecommons.org/licenses/by-sa/4.0/legalcode.zh-hans](https://creativecommons.org/licenses/by-sa/4.0/legalcode.zh-hans)
